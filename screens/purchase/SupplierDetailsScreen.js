...
export default function SupplierDetailsScreen(props) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerInfoCustomer}>
        ...
        />
        <Text style={styles.headerInfoNameCustomer}>{supplier.name}</Text>
        ...
        >
          <TouchableOpacity
            ...
            onPress={() =>
              props.navigation.push("MainStack", {
                screen: "Devis Fournisseurs",
                params: {
                  filter_string: `?filters=[('partner_id', '=', ${supplier.id})]`,
                },
              })
            }
          >
            <Text style={styles.headerInfoSaleText}>Achat</Text>
          ...
          <View style={styles.headerInfoTotal}>
            ...
            <Text style={styles.headerInfoSaleText}>
              {parseFloat(supplier.total_invoiced).toFixed(3)}{" "}
      ...
      <View style={styles.infoCustomer}>
        ...
        <Text style={styles.infoCustomerText}>
          ...
          {supplier.street || "-"} {supplier.street2 || "-"}{" "}
          {supplier.city || "-"} {supplier.zip || "-"}
          {"\n"} {supplier?.state_id?.name || "-"}{" "}
